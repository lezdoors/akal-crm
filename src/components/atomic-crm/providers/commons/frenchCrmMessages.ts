...
export const frenchCrmMessages = {
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Bienvenue sur Maison Tanneurs CRM",
    },
    common: {
      activity: "Activité",
      added: "ajoutée",
    ...
    dashboard: {
      ...
      stepper: {
        install: "Installer Maison Tanneurs CRM",
    ...
    profile: {
      inbound: {
        description:
          "Vous pouvez commencer à envoyer des e-mails vers l'adresse de réception de votre serveur, par exemple en l'ajoutant au champ %{field}. Maison Tanneurs CRM traitera les e-mails et ajoutera des notes aux contacts correspondants.",
