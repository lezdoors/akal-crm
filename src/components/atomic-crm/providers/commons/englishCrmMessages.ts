export const englishCrmMessages = {
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Welcome to Maison Tanneurs CRM",
    },
    common: {
      activity: "Activity",
      added: "added",
    ...
    dashboard: {
      ...
      stepper: {
        install: "Install Maison Tanneurs CRM",
    ...
    profile: {
      inbound: {
        description:
          "You can start sending emails to your server's inbound email address, e.g. by adding it to the %{field} field. Maison Tanneurs CRM will process the emails and add notes to the corresponding contacts.",
        title: "Inbound email",
      },
      mcp: {
        title: "MCP Server",
