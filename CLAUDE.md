...
- **Deployment**: own Vercel project (static `dist/`), reached at **akalds.com/crm** via a rewrite in `lezdoors/akalds` vercel.json. Hash routing + relative base = subpath-portable; do not add a BrowserRouter.
